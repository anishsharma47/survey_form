  ...
  return (
    <div className=" bg-gray-100">
      <div className=" rounded-lg shadow-lg w-full flex">
        {/* LEFT SIDE CONTAINER */}
        <div className="w-[300px] fixed left-0 top-0 bg-white min-h-full text-black pt-10 px-5 rounded-xl hidden md:block">
        ...
        <div className="ml-0 md:ml-[300px] w-full md:w-[80%] min-h-screen space-y-10  md:space-y-16 text-black p-6 md:p-10  lg:p-20">
